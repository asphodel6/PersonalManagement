...
import { AccountsHttpService } from './services/userdata.service';
...
export class UsersComponent implements OnInit {
  ...
  constructor(
    ...
    public usersServive: AccountsHttpService
  ) {
  ...
  public getServerData(event?: PageEvent): PageEvent {
    this.usersServive.getUsers(event).subscribe(
      (response: IUser[]) => {
        if (!response) {
          // handle error
        } else {
  ...
  public ngOnInit(): void {
    ...
    initPage.length = this.usersServive.getCount();
